<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold">
                                Editar Perfil Tiroideo
                            </h2>

                            <p class="text-cyan-100 text-sm">
                                Actualiza los resultados del perfil tiroideo
                            </p>
                        </div>
                    </div>
            ...
            <form
                action="{{ route('tiroides.update', $consulta->id) }}"
                method="POST"
                class="space-y-6"
            >
                @csrf
