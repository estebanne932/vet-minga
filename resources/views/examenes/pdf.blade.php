...
<body>
    ...
    <div class="title">EXAMEN DE ORINA</div>
    <div class="subtitle">Resultados del paciente</div>
    ...
    <div class="card">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($primero->fecha)->format('d/m/Y') }}</td>
            </tr>
            <tr>
                <td class="info-label">Color:</td>
                <td>{{ $primero->color ?? '—' }}</td>
                <td class="info-label">Aspecto:</td>
                <td>{{ $primero->aspecto ?? '—' }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="card">
        ...
        <table class="results-table">
            <thead>
                <tr>
                    <th width="34%">Parámetro</th>
                    <th width="18%" style="text-align:center;">Resultado</th>
                    <th width="24%" style="text-align:center;">Referencia</th>
                    <th width="24%" style="text-align:center;">Estado</th>
                </tr>
            </thead>
            ...
            <tbody>
                @foreach ($examenes as $item)
                    @php
                        $resultadoTexto = strtoupper(trim($item->resultado ?? ''));
                        ...
                        if (!empty($matches)) {
                            ...
                            $dentroRango = $resultadoTexto === $referenciaNormalizada;
                        }
                    @endphp
                    ...
                    <tr>
                        ...
                        <td class="resultado {{ $dentroRango ? 'ok' : 'bad' }}">
                            {{ $item->resultado }}
                        </td>
