...
<body>
    ...
    <div class="subtitle">Resultados bioquímicos del paciente</div>
    ...
    <div class="card">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>{{ $quimica->first()->paciente }}</td>
                <td class="info-label">Especie:</td>
                <td>{{ $quimica->first()->especie }}</td>
            </tr>
            <tr>
                <td class="info-label">Veterinario:</td>
                <td>{{ $quimica->first()->veterinario }}</td>
                <td class="info-label">Fecha:</td>
                <td>{{ \Carbon\Carbon::parse($quimica->first()->fecha)->format('d/m/Y') }}</td>
            </tr>
        </table>
    </div>
