@php
    $esFelino = in_array(
        strtolower($quimica->first()->especie),
        ['felino', 'gato', 'felina']
    );
@endphp
...
<body>
    ...
    <div class="card">
        <table>
            <tr>
                <td><strong>Mascota:</strong> {{ $quimica->first()->paciente }}</td>
                <td><strong>Especie:</strong> {{ $quimica->first()->especie }}</td>
            </tr>
            <tr>
                <td><strong>Veterinario:</strong> {{ $quimica->first()->veterinario }}</td>
                <td>
                    <strong>Fecha:</strong>
