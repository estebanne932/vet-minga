<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-cyan-100 text-sm">
                                Captura de resultados bioquímicos del paciente
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg ring-1 ring-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        ...
                        <p class="font-semibold text-gray-800">{{ strtoupper($consulta->mascota->especie) }}</p>
                    </div>
            ...
            {{-- FORMULARIO --}}
            <form method="POST" action="{{ route('quimica.store', $consulta) }}">
                @csrf
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-gradient-to-r from-cyan-600 to-teal-600 text-white">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-center font-semibold">Perro</th>
                                    <th class="px-6 py-4 text-center font-semibold">Gato</th>
                                </tr>
                            </thead>
