            ...
            <div class="bg-gradient-to-r from-cyan-600 to-teal-600 rounded-2xl p-6 text-white shadow-lg">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-cyan-100 text-sm">
                                Resultados bioquímicos del paciente
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a
                            href="{{ route('quimica.pdf', $consulta) }}"
                            target="_blank"
            ...
            <div class="bg-white rounded-2xl shadow-lg ring-1 ring-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        ...
                        <p class="font-semibold text-gray-800">{{ $quimica->first()->paciente }}</p>
                    </div>

                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        <p class="text-gray-500 mb-1">Especie</p>
                        <p class="font-semibold text-gray-800">{{ $quimica->first()->especie }}</p>
                    </div>

                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        <p class="text-gray-500 mb-1">Veterinario</p>
                        <p class="font-semibold text-gray-800">{{ $quimica->first()->veterinario }}</p>
                    </div>

                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        <p class="text-gray-500 mb-1">Fecha</p>
                        <p class="font-semibold text-gray-800">
                            {{ \Carbon\Carbon::parse($quimica->first()->fecha)->format('d/m/Y') }}
                        </p>
                    </div>
                </div>
            </div>
