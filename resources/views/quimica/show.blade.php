    ...
    <div class="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div class="bg-white rounded shadow p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <p><strong>Mascota:</strong> {{ $quimica->first()->paciente }}</p>
                <p><strong>Especie:</strong> {{ $quimica->first()->especie }}</p>
                <p><strong>Veterinario:</strong> {{ $quimica->first()->veterinario }}</p>
