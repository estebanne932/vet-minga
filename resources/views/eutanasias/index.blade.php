                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            @forelse ($eutanasias as $eutanasia)
                                <tr class="hover:bg-cyan-50/60 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 whitespace-nowrap">
                                        {{ $eutanasia->propietario->nombre ?? '—' }}
                                    </td>

                                    <td class="px-6 py-4 text-gray-700 whitespace-nowrap">
                                        {{ $eutanasia->mascota->nombre ?? '—' }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-gray-700 whitespace-nowrap">
                                        {{ $eutanasia->veterinario }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        @if($eutanasia->archivo_pdf)
                                            <a
                                                href="{{ asset('storage/' . $eutanasia->archivo_pdf) }}"
                                                target="_blank"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <a
                                                href="{{ route('eutanasias.show', $eutanasia) }}"
                                            ...
                                            <form
                                                action="{{ route('eutanasias.destroy', $eutanasia->id) }}"
                                                method="POST"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-10 text-center">
                                        <div class="flex flex-col items-center gap-2 text-gray-500">
                                            ...
                                            <p class="text-sm">Agrega el primer registro de eutanasia para comenzar.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
